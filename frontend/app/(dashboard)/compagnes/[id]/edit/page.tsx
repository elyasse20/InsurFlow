      ...
      <div className="flex items-center gap-3">
        ...
        <div className="space-y-1">
          <div className="flex items-center gap-2.5">
            ...
            <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-foreground">Modifier la compagnie</h1>
          </div>
          <p className="text-xs sm:text-sm text-muted-foreground pl-10">Mettre à jour les catégories et paramètres de la compagnie</p>
        </div>
      </div>
